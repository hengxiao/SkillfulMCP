...
- [`integrations/claude-code.md`](integrations/claude-code.md) — three patterns for plugging a deployed catalog into Claude Code (skill sync, MCP-protocol bridge, slash command).
