"""
LangChain runner — uses `SkillfulLangChainAgent`, which subclasses
...
from example.skillful import SkillfulLangChainAgent
...
def build_agents(config, server_url, admin_key, llm):
    agents: dict[str, SkillfulLangChainAgent] = {}
    roles: dict[str, str] = {}
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run via LangChain.")
